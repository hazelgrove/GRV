...
\begin{tikzpicture}
  ...
  ,node distance=0mm]
  \node (Editor_t)             [on chain=1,header] {\large Editor.t};
  ...
  \node [draw,fit=(Editor_id) (Editor_known_actions)] {};
...
%   % \node (Action_edit) [right=4mm of Action_t.two east] {Action.edit};
%   % \node (Action_move) [above=0mm of Action_edit] {Action.move};
%   % \node (Action_comm) [below=0mm of Action_edit] {Action.comm};

%   % \draw ([xshift=-2mm]Action_t.two east) -- ([xshift=2mm]Action_t.two east);
%   % \draw ([xshift=2mm]Action_t.two east) |- (Action_edit);
%   % \draw ([xshift=2mm]Action_t.two east) |- (Action_move);
%   % \draw ([xshift=2mm]Action_t.two east) |- (Action_comm);

%   % \draw (Action_comm.east) -- ([xshift=2mm]Action_comm.east) |- (Graph_action_t.east);
% \end{tikzpicture}
